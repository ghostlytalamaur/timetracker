...
//                projection = new String[] {proj};
                ...
                projection = new String[] {selectProjectionByQuery(uriID)};
                groupBY = selectGroupByQuery(uriID);
                break;
    ...
    private String selectProjectionByQuery(int uriID) {
        switch (uriID) {
            case GROUP_NONE:
                final String PROJ_GROUP_NONE =
                        "   %1$s as '%3$s', " +
    ...
    private String selectGroupByQuery(int uriID) {
        switch (uriID) {
            case GROUP_DAY:
